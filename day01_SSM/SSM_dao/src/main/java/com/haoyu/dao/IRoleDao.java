...
public interface IRoleDao {
    ...
    @Results({
            ...
            @Result(property = "permissions",column = "id",javaType = java.util.List.class,many = @Many(select = "com.haoyu.dao.IPermissionDao.findPermissionByRoleId"))
    })
