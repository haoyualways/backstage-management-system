				...
				<div class="box box-primary">
					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								...
								<select class="form-control" id="changePageSize" onchange="changePageSize()">
									<option value="" disabled selected hidden>${userList.pageSize}</option>
									<option>2</option>
									<option>4</option>
									<option>6</option>
									<option>8</option>
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li>
									<a href="${pageContext.request.contextPath}/user/findAll?page=1&size=${userList.pageSize}" aria-label="Previous">首页</a>
								</li>
								...
								<li>
									<a href="${pageContext.request.contextPath}/user/findAll?page=${userList.pages}&size=${userList.pageSize}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</div>
